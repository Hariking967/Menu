               ...
               <Form {...form}>
                <form onSubmit={ form.handleSubmit(onSubmit)} className='p-6 md:p-8'>
                  <div className='flex flex-col g-6'>
                    ...
                    <div className='grid gap-3 m-1.5'>
                      ...
                      render={({field})=>{
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type='email' placeholder='me@gmail.com' {...field}></Input>
                          </FormControl>
                          <FormMessage></FormMessage>
                        </FormItem>)
                        }}>  
                    ...
                    <Button disabled={pending} className='w-full m-1.5' type='submit'>
                      Sign Up
                    </Button>
                    ...
                    <div className='text-center text-sm'>
                      Already have an account?<Link className='underline underline-offset-4' href='/auth/sign-in'></Link>
                    </div>
                  </div>
                </form>
               </Form>
                <div className="bg-gradient-to-br from-blue-400 via-pink-600 to-yellow-300 relative hidden md:flex flex-col gap-y-4 items-center justify-center h-full w-full p-4">
                    ...
                    <p className='text-2xl font-semibold text-white'>Nimets</p>
                </div>
            </CardContent>
        </Card>

        <div className='text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4'>
          By Clicking continue, you are going to our <a href='#'>Terms of service</a> and <a href='#'>Privay Policy</a>
        </div>
    </div>
  )
}
